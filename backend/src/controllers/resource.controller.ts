...
export async function getResourcesController(req: AuthenticatedRequest, res: Response) {
  try {
...
export async function getResourceController(req: AuthenticatedRequest, res: Response) {
  try {
...
export async function getResourcesForNodeController(req: AuthenticatedRequest, res: Response) {
  try {
...
export async function createResourceController(req: AuthenticatedRequest, res: Response) {
  try {
...
export async function updateResourceController(req: AuthenticatedRequest, res: Response) {
  try {
    const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
    const userId = req.user?.user_id || null;
    const ipAddress = req.ip || req.socket.remoteAddress || null;
...
export async function deleteResourceController(req: AuthenticatedRequest, res: Response) {
  try {
    const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
    const userId = req.user?.user_id || null;
    const ipAddress = req.ip || req.socket.remoteAddress || null;
...
export async function calculateResourceController(req: AuthenticatedRequest, res: Response) {
  try {
    const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
