import { getAllMaintenancePlans, getMaintenancePlanById, createMaintenancePlan, updateMaintenancePlan, deleteMaintenancePlan, getAllMaintenanceTasks, getMaintenanceTaskById, createMaintenanceTask, updateMaintenanceTask, deleteMaintenanceTask, addTaskToPlan, removeTaskFromPlan, generateMaintenancePlan, } from '../services/maintenance.service.js';
// Планы ТО
export async function getMaintenancePlansController(req, res) {
    try {
...
export async function getMaintenancePlanController(req, res) {
    try {
...
export async function createMaintenancePlanController(req, res) {
    try {
...
export async function updateMaintenancePlanController(req, res) {
    try {
        const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
        const userId = req.user?.user_id || null;
        const ipAddress = req.ip || req.socket.remoteAddress || null;
...
export async function deleteMaintenancePlanController(req, res) {
    try {
        const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
        const userId = req.user?.user_id || null;
        const ipAddress = req.ip || req.socket.remoteAddress || null;
...
// Задачи ТО
export async function getMaintenanceTasksController(req, res) {
    try {
...
export async function getMaintenanceTaskController(req, res) {
    try {
        const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
...
export async function createMaintenanceTaskController(req, res) {
    try {
        const userId = req.user?.user_id || null;
        const ipAddress = req.ip || req.socket.remoteAddress || null;
        const userAgent = req.headers['user-agent'] || null;
...
export async function updateMaintenanceTaskController(req, res) {
    try {
        const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
        const userId = req.user?.user_id || null;
        const ipAddress = req.ip || req.socket.remoteAddress || null;
...
export async function deleteMaintenanceTaskController(req, res) {
    try {
        const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
        const userId = req.user?.user_id || null;
        const ipAddress = req.ip || req.socket.remoteAddress || null;
...
export async function addTaskToPlanController(req, res) {
    try {
...
export async function removeTaskFromPlanController(req, res) {
    try {
        const planId = Array.isArray(req.params.planId) ? req.params.planId[0] : req.params.planId;
        const taskId = Array.isArray(req.params.taskId) ? req.params.taskId[0] : req.params.taskId;
        const userId = req.user?.user_id || null;
...
// Генерация плана
export async function generateMaintenancePlanController(req, res) {
    try {
