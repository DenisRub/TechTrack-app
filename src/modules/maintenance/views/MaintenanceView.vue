<template>
  <div class="card">
    ...
    <!-- Таблица планов-графиков с иконками сортировки -->
...
const filteredAndSortedPlans = computed(() => {
  ...
  // Сортировка: сначала те, у кого дата начала ближе к текущей
...
function viewPlan(id: number) { router.push(`/maintenance/${id}`); }
...
.filter-panel {
  background: #f8f9fa; border: 1px solid #e0e4e8; border-radius: 8px;
